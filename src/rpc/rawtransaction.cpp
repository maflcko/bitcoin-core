...
static RPCMan getrawtransaction()
{
    return RPCMan{
                "getrawtransaction",
...
static RPCMan gettxoutproof()
{
    return RPCMan{"gettxoutproof",
...
static RPCMan verifytxoutproof()
{
    return RPCMan{"verifytxoutproof",
...
static RPCMan createrawtransaction()
{
    return RPCMan{"createrawtransaction",
...
static RPCMan decoderawtransaction()
{
    return RPCMan{"decoderawtransaction",
...
static RPCMan decodescript()
{
    return RPCMan{"decodescript",
...
static RPCMan combinerawtransaction()
{
    return RPCMan{"combinerawtransaction",
...
static RPCMan signrawtransactionwithkey()
{
    return RPCMan{"signrawtransactionwithkey",
...
static RPCMan sendrawtransaction()
{
    return RPCMan{"sendrawtransaction",
                ...
                "\nAlso see createrawtransaction and signrawtransactionwithkey calls.\n",
                {
                    ...
                    {"maxfeerate|allowhighfees", RPCArg::Type::AMOUNT, /* default */ FormatMoney(DEFAULT_MAX_RAW_TX_FEE_RATE.GetFeePerK()),
...
static RPCMan testmempoolaccept()
{
    return RPCMan{"testmempoolaccept",
            ...
            "                                        Length must be one for now.",
                    ...
                    {"maxfeerate|allowhighfees", RPCArg::Type::AMOUNT, /* default */ FormatMoney(DEFAULT_MAX_RAW_TX_FEE_RATE.GetFeePerK()), "Reject transactions whose fee rate is higher than the specified value, expressed in " + CURRENCY_UNIT + "/kB\n"},
                },
                RPCResult{
...
static RPCMan decodepsbt()
{
    return RPCMan{"decodepsbt",
...
static RPCMan finalizepsbt()
{
    return RPCMan{"finalizepsbt",
...
static RPCMan createpsbt()
{
    return RPCMan{"createpsbt",
...
static RPCMan converttopsbt()
{
    return RPCMan{"converttopsbt",
...
static RPCMan utxoupdatepsbt()
{
    return RPCMan{"utxoupdatepsbt",
...
static RPCMan joinpsbts()
{
    return RPCMan{"joinpsbts",
...
static RPCMan analyzepsbt()
{
    return RPCMan{"analyzepsbt",
...
{ //  category              name                            actor (function)            argNames
  //  --------------------- ------------------------        -----------------------     ----------
    ...
    { "rawtransactions",    "sendrawtransaction",           &sendrawtransaction,        {"hexstring","maxfeerate|allowhighfees"} },
    { "rawtransactions",    "combinerawtransaction",        &combinerawtransaction,     {"txs"} },
    { "rawtransactions",    "signrawtransactionwithkey",    &signrawtransactionwithkey, {"hexstring","privkeys","prevtxs","sighashtype"} },
    { "rawtransactions",    "testmempoolaccept",            &testmempoolaccept,         {"rawtxs","maxfeerate|allowhighfees"} },
