 ...
 *
 * Things to be aware of when writing code that deals with std::span's:
 *
 * - Similar to references themselves, std::span's are subject to reference lifetime
 ...
 *
 * - One particular pitfall is that std::span's can be constructed from temporaries,
